...
<a class="card" href=${`/details/${recipe.objectId}`}> <article class="recent">
...
export function homePage(ctx) {
    ctx.render(homeTemplate(recipeLoad()))
...
async function recipeLoad() {
    ...
    if (recipes.length == 0) {
        return html`<p>Not recipes found!</p>`
    }
